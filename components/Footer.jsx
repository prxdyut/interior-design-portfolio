                ...
                <div className="grid gap-4 pb-4 text-left lg:pb-0 lg:grid-cols-3">
                    <div>
                        ...
                        <div className="flex flex-col ">
                            <Link className="py-1 hover:underline" href="/about">Projects</Link>
                            <Link className="py-1 hover:underline" href="/press">Gallery</Link>
                            <Link className="py-1 hover:underline" href="/careers">Contact</Link>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col ">
                            ...
                            <Link className="py-1 hover:underline" href="/careers">Join Newsletter</Link>
                            <Link className="py-1 hover:underline" href="/contact">Talk to us</Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="py-10 bg-zinc-200">
                <div className="container text-center text-gray-500 lg:justify-between lg:flex">
                    <div className="pb-4 lg:pb-0">
                        <p>&copy;2023 REGAL INDUSTRIES.</p>
                    </div>
                    <div className="">
